...
class PreCLayers(nn.Module):
    def __init__(self, n_qubits):
        super(PreCLayers, self).__init__()
...
class PostCLayers(nn.Module):
    def __init__(self, n_qubits, n_classes):
        super(PostCLayers, self).__init__()
...
class Model(nn.Module):
    def __init__(self, n_qubits, classes, n_layers, data_reupload):
        ...
        self.pre_clayer = PreCLayers(self.n_qubits)
        self.post_clayer = PostCLayers(self.n_qubits, self.number_classes)
